...
public class MyUserDetailsService implements UserDetailsService {
    ...
    throws UsernameNotFoundException, DataAccessException {
        ...
        List<ResourceInfo> resources=this.getResourceByUsername(username);
    ...
    private List<ResourceInfo> getResourceByUsername(String username){  
        ...
        List<ResourceInfo> list =this.baseDao.findListBeanByArray(sql, ResourceInfo.class, new Object[] { username });
        return list;  
    }
